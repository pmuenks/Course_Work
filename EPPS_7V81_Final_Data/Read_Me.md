This respository contains the files to replicate my final project for EPPS 7V81. The raw data work can be completed by running the Python file first and then the R file.
